    ...
    <div className="block mb-2 font-semibold font-poppins">
      ...
      <div className="flex justify-center border border-black-500 grid grid-cols-1 flex  w-3/4  p-10 gap-5 ml-20">
        <div className="flex justify-center underline text-xl">
          <h1>Health Centre - Laboratory - University Of Peradeniya</h1>
        </div>
        ...
        <div className=" bg-white border-b border-black-800">
          <table className="min-w-full divide-y divide-black-200 border border-gray-300">
            ...
            <tbody>
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Colour</td>
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Appearance</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
            ...
            <tbody>
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Reaction (pH)</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Proteins</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Bilirubin</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Ketones</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Nitrite</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
            ...
            <tbody>
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Pus Cells</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
                ...
                <td className="px-6 py-4 whitespace-nowrap">/ hpf</td>
              </tr>
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Red Cells</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Casts</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Crystals</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Organisms</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={titreNumber}
        ...
        <div className="grid grid-cols-2 gap-5 mr-0 w-1/2 right-0 mt-10">
          <button className="bg-red-500 p-4 rounded-full  hover:shadow-lg transform hover:scale-105 transition-all duration-300">
            Save Draft
          </button>
          <button className="bg-blue-500 p-4 rounded-full hover:shadow-lg transform hover:scale-105 transition-all duration-300">
            Submit
          </button>
        </div>
      </div>
