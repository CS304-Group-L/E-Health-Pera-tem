                    ...
                    <table className="min-w-full divide-y divide-black-200 border border-gray-300">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap"> 2.0 - 6.0</td>
                            </tr>
                            <tr>
                            <td className="px-6 py-4 whitespace-nowrap">
                                    Clotting Time
                                ...
                                <td className="px-6 py-4 whitespace-nowrap"> Minutes</td>
                                <td className="px-6 py-4 whitespace-nowrap"> 3.0 - 9.0</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
