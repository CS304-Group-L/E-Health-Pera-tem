      ...
      <div className="flex justify-center border border-black-500 grid grid-cols-1 flex  w-3/4  p-10 gap-5 ml-20">
        ...
        <div className=" bg-white border-b border-black-800">
          <table className="min-w-full divide-y divide-black-200 border border-gray-300">
            ...
            <tbody>
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Total Protein</td>
                ...
                <td className="px-6 py-4 whitespace-nowrap"> g/l</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={result}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Albumin</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={result}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Globulin</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={result}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">Bilirubin Total</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={result}
                ...
                <td className="px-6 py-4 whitespace-nowrap"> mg/l</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={result}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">S.G.P.T (ALT)</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={result}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">S.G.O.T (AST)</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={result}
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">GAMMA – GT</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <input
                    type="text"
                    value={result}
