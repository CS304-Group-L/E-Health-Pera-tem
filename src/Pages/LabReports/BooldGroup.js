...
function BloodGroup() {
    ...
    const handleBloodGrouponChange = (event) => {
        setBloodGroup(event.target.value);
      };

      const handleRHonChange = (event) => {
                    ...
                    <table className="min-w-full divide-y divide-black-200 border border-gray-300">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
      <select id="selectionList" value={bloodGroup} onChange={handleBloodGrouponChange}>
        ...
        <option value="O">O</option>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap"> 
                                <select id="selectionList" value={RH} onChange={handleRHonChange}>
        <option value="">Select RH Condition</option>
